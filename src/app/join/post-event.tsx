            ...
            {phase === "review" && pending.length === 0 ? (
                <View style={styles.emptyState}>
                    ...
                    <Text style={styles.emptyText}>
                        You didn't connect with anyone this time. Jump into the
                        next event to meet people!
                    </Text>
                </View>
            ) : (
                <ScrollView
                ...
                >
                    {phase === "review" &&
                        pending.map(
                            ({ connection, otherUser, emoji, metVia }) => (
                                <ReviewCard
                                    key={connection.id}
                                    name={otherUser.name}
                    ...
                    {phase === "planned" && events.length === 0 && (
                        <View style={styles.emptyState}>
                            <Text style={styles.emptyEmoji}>🌱</Text>
                            <Text style={styles.emptyText}>
                                Nothing to plan yet. Approve more connections or
                                add free slots and try again.
                            </Text>
                        </View>
                    )}
